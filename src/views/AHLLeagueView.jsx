...
// pass (playoff bracket data, AI-driven power rankings). No player-detail
// popup on leader rows either (no AHLPlayerPopup component built this
// pass) -- see AHL_BUILD_BRIEF.md's scope notes.
