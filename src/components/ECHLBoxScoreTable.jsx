...
//
// Per-player skater/goalie table for ECHLGameStatsPopup -- port of
// AHLBoxScoreTable.jsx. Drops HIT/BLK/FO% columns entirely: confirmed
// live that ECHL's gameSummary reports hits/faceoffAttempts/faceoffWins/
// blockedShots as exactly 0 for every skater regardless of real ice
// time, same as AHL, so echl_skater_game_box was never given those
// columns at all -- there's nothing to render, not a formatting choice.
// Skater TOI is dropped for the same reason (always "0:00" in the
// source feed). Goalie TOI/SA/SV/SV%/GA ARE real per-game numbers and
// are kept, same as AHL's table.
...
export default function ECHLBoxScoreTable({ skaters, goalies, playerNames }) {
