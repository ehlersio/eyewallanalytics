...
│   │   ├── IceRink.jsx                 # SVG rink — shots, heat map, team-aware — Tailwind (Phase 6), no .css file; .rink-btn shared style extracted to utils/rinkBtnClasses.js (also used by SeasonChipRow.jsx, PWHLShotMapView.jsx, ShotMapView.jsx)
