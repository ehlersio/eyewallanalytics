...
│   │   ├── PeriodSummary.jsx/.css      # Period/game summary popup + share canvas + hat trick badges — popup half Tailwind (Phase 4, sub-PR 5a), share canvas half still plain CSS (sub-PR 5b)
│   │   ├── PWHLPeriodSummary.jsx/.css  # PWHL period/game summary popup + share canvas — same split as above
